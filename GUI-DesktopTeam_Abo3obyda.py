...
# Form implementation generated from reading ui file 'pl2.ui'
#
...
# camera ip
camera_ip = 'http://192.168.137.9:8080/video'
...
class Ui_GripperRobotController(object):
    def setupUi(self, GripperRobotController):
        ...
        GripperRobotController.resize(1444, 868)
        font = QtGui.QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.Qr = QtWidgets.QPushButton(self.Control)
        self.Qr.setGeometry(QtCore.QRect(270, 70, 161, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
        self.Qr.setFont(font)
        self.Qr.setStyleSheet("background-color: rgb(85, 0, 0);\n"
"color: rgb(255, 255, 255);")
        self.Qr.setObjectName("Qr")
        self.opencamera = QtWidgets.QPushButton(self.Control)
        self.opencamera.setGeometry(QtCore.QRect(250, 20, 211, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
        self.opencamera.setFont(font)
        self.opencamera.setStyleSheet("background-color: rgb(85, 0, 0);\n"
"color: rgb(255, 255, 255);")
...
"color: rgb(255, 255, 255);")
        ...
        self.Camera.setGeometry(QtCore.QRect(30, 90, 651, 301))
        self.Camera.setText("")
...
"background-color: rgb(255, 0, 127);")
        ...
        self.Qr.setShortcut('x')
        self.Qr.pressed.connect(self.read_qr)
        self.opencamera.setShortcut('c')
        self.opencamera.pressed.connect(self.Cameraopen)
    ...
    # wifi with esp
    def send_data(self):
        esp32_ip = '192.168.137.76'  # Replace with the ESP32's IP address
...
##Control functions
    ...
    def retranslateUi(self, GripperRobotController):
        ...
        self.Qr.setText(_translate("GripperRobotController", "read_qr"))
        self.opencamera.setText(_translate("GripperRobotController", "open Camera"))
